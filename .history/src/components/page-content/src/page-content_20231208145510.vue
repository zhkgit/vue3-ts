    ...
    <div class="page-content">
        ...
        >
            <template #headerHandler>
                <el-button type="primary" size="small" v-if="isCreate">新建用户</el-button>
            ...
            <template #handler="scope">
                <el-button link type="primary" v-if="isUpdate"> 编辑 </el-button>
...
import { computed, ref, defineProps, PropType, defineExpose, watch } from 'vue'
